...
//     "id": "41acb7c0-cad0-11ed-8e21-abfcc0442e8f",
//     "number": 3,
...
//                 "actions": [
//                     {
//                         type: "SendMail", email_template: "T001",
//                         params: [
//                             { type: "field", value: ["$requester.fullname"], name: "RequesterName" },
//                             { type: "field", value: ["$name"], name: "Subject" },
//                             { type: "field", value: ["$id"], name: "IDTicket" },
//                             { type: "concat", value: ['https://ticket.vn/', '$id'], name: "TicketLink" },
//                             { type: "concat", value: ['https://ticket.vn/', '$id'], name: "RequestLink" },
...
//     // const environment = configs.environment as string;
...
//    actionSendMail(value, "afd502fa-b330-11ed-afa1-0242ac120002", "afd505b6-b330-11ed-afa1-0242ac120002", "41acb7c0-cad0-11ed-8e21-abfcc0442e8f", "request", "ducnv2509")
// }
